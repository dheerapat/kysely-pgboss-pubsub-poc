...
Reference full template: `/home/dheeto/dev/kysely-pgboss-pubsub-poc/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/dheeto/dev/kysely-pgboss-pubsub-poc/.opencode/get-shit-done/templates/state.md`.
