...
Use template from `/home/dheeto/dev/kysely-pgboss-pubsub-poc/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/dheeto/dev/kysely-pgboss-pubsub-poc/.opencode/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/dheeto/dev/kysely-pgboss-pubsub-poc/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
