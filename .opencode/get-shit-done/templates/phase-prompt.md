...
<!-- For checkpoint task examples and patterns, see @/home/dheeto/dev/kysely-pgboss-pubsub-poc/.opencode/get-shit-done/references/checkpoints.md -->
...
See `/home/dheeto/dev/kysely-pgboss-pubsub-poc/.opencode/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/home/dheeto/dev/kysely-pgboss-pubsub-poc/.opencode/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/home/dheeto/dev/kysely-pgboss-pubsub-poc/.opencode/get-shit-done/workflows/verify-phase.md` for verification logic.
