...
- Usage: Reference from command with `@/home/dheeto/dev/kysely-pgboss-pubsub-poc/.opencode/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/dheeto/dev/kysely-pgboss-pubsub-poc/.opencode/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/dheeto/dev/kysely-pgboss-pubsub-poc/.opencode/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
