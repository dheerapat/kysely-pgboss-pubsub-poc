...
- **Global scope**: `/home/dheeto/dev/kysely-pgboss-pubsub-poc/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/dheeto/dev/kysely-pgboss-pubsub-poc/.opencode/notes/`)
...
2. Glob `/home/dheeto/dev/kysely-pgboss-pubsub-poc/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/dheeto/dev/kysely-pgboss-pubsub-poc/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/dheeto/dev/kysely-pgboss-pubsub-poc/.opencode/notes/` — works in any directory
