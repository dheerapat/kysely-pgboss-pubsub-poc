...
<required_reading>
@/home/dheeto/dev/kysely-pgboss-pubsub-poc/.opencode/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/home/dheeto/dev/kysely-pgboss-pubsub-poc/.opencode/get-shit-done/bin/gsd-tools.cjs" init resume)
