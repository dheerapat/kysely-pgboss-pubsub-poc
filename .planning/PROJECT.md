...
- [ ] Typed event bus abstraction wrapping pg-boss — domain code never calls pg-boss directly
...
- [ ] HTTP API (Hono or Elysia) as the trigger surface — curl to trigger the full flow
