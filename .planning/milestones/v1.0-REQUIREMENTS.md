...
- [x] **HTTP-04**: `POST /users` with a duplicate email returns a 409 error and demonstrates that no `user.registered` job was created (transaction rolled back atomically)
...
- [x] **DEMO-02**: A `README.md` documents the pattern thesis, the folder structure, and includes annotated curl commands to run the full demo flow
...
*Last updated: 2026-03-21 after Phase 4 completion (HTTP-04, DEMO-02 marked complete)*
